...
WARM_GRACE = PlannerTheme(
    ...
    planner_types=(FAITH,),
    paper="#FFFDF9", ink="#2B2321", muted="#6A5E58",
...
MODERN_MINIMAL = PlannerTheme(
    ...
    planner_types=(FAITH,),
    paper="#FFFFFF", ink="#1E1E1E", muted="#605C58",
...
FLORAL_DEVOTION = PlannerTheme(
    ...
    planner_types=(FAITH,),
    paper="#FFFDFC", ink="#3B2F35", muted="#6B5B63",
    primary="#8C4F63", accent="#7D9B80", accent_soft="#F8EDF0",
...
FAMILY_HERITAGE = PlannerTheme(
    ...
    planner_types=(FAITH,),
    paper="#FFFCF7", ink="#2D2520", muted="#63574C",
...
JOYFUL_LIGHT = PlannerTheme(
    ...
    planner_types=(FAITH,),
    paper="#FFFFFF", ink="#25303B", muted="#586572",
...
LEDGER = PlannerTheme(
    ...
    paper="#FFFFFF", ink="#1F2624", muted="#55605D",
    ...
    cover_art="teal_ledger", cover_style_default="soft_overlay",
